...
public class ShipmentController {
    ...
    public CommonResponse AddShipment(@RequestBody Shipment shipment) {
        boolean res = shipmentBackendService.addShipment(shipment.getUser_id(), shipment.getCarrier(), shipment.getFrom(), shipment.getTo());
        if( res) {
    ...
    public CommonResponse DeleteShipmentById(@RequestParam BigInteger id) {
        boolean res = shipmentBackendService.deleteShipmentById(id);
        if(res) {
            return CommonResponse.ok(res);
        }
    ...
    @CrossOrigin
    @PutMapping("/update")
    public CommonResponse UpdateShipment(@RequestBody UpdateShipmentDTO updateShipmentDTO) {
        boolean res = shipmentBackendService.updateShipment(updateShipmentDTO.getId(),updateShipmentDTO.getCarrierId(),updateShipmentDTO.getStatus());
        if(res) {
            return CommonResponse.ok(res);
        }
    ...
    public CommonResponse GetAllShipment() {
        List<Shipment> listShipment = shipmentBackendService.getAllShipment();
    ...
    public CommonResponse GetShipmentById(@RequestParam BigInteger id) {
        Shipment shipment = shipmentBackendService.getShipmentById(id);
    ...
    public CommonResponse GetShipmentByCarrierId(@RequestParam BigInteger carrierId) {
        List<Shipment> listShipment = shipmentBackendService.getShipmentByCarrierId(carrierId);
